...
function Model(props: JSX.IntrinsicElements['group']) {
    ...
    const { nodes, materials } = useGLTF('/perseverance_-_nasa_mars_landing_2021/scene.gltf') as GLTFResult
...
function Details() {
    ...
    if (snap.current === "aluminum_black")
        return (
            <div className=" h-full md:flex md:flex-col md:justify-center pr-4 font-fontVollkorn">
                <h1 className="text-3xl uppercase">Wheels</h1>
                <p className="text-xl text-justify">The Perseverance rover has six wheels, each with its own individual motor.
        ...
        return (
            <div className=" h-full md:flex md:flex-col md:justify-center pr-4 font-fontVollkorn">
                <h1 className="text-3xl uppercase">Navigation Cameras (Navcams)</h1>
                <p className="text-xl text-justify">Two color stereo Navigation Cameras, called Navcams, help engineers navigate Perseverance safely, particularly when the rover operates autonomously, making its own navigation decisions without consulting controllers on Earth.</p>
            </div>
        )
    }
        ...
        return (
            <div className=" h-full md:flex md:flex-col md:justify-center pr-4 font-fontVollkorn">
                <h1 className="text-3xl uppercase">Turret</h1>
                <p className="text-xl text-justify">At the end of the arm is the "turret." It's like a hand that carries scientific cameras, mineral and chemical analyzers for studying the past habitability of Mars, and choosing the most scientifically valuable sample to cache.</p>
            </div>
        )
    }
    else if (snap.current === "UHF Antenna") {
        return (
            <div className=" h-full md:flex md:flex-col md:justify-center pr-4 font-fontVollkorn">
                <h1 className="text-3xl uppercase">Wheels</h1>
                <p className="text-xl text-justify">Most often, Mars 2020 uses its ultra-high frequency (UHF) antenna (about 400 megahertz) to communicate with Earth through NASA's orbiters around Mars. Because the rover and orbiter antennas are within close range of each other, they act a little like walky-talkies compared to the long-range telecommunications with Earth provided by the low-gain and high-gain antennas.
                </p>
            </div>
        )
    }
        ...
        return (
            <div className="h-full md:flex md:flex-col md:justify-center font-fontVollkorn">
                <h1 className="text-2xl tracking-wider">Click on different parts of rover for more information</h1>
            </div>
        )
    }
}
...
export default function Perseverance() {
    return (
        <>
            <div className="text-white font-fontVollkorn text-6xl pl-8 bg-primaryBg" id="rover">The Mars Rover</div>
            <div className="md:grid md:grid-cols-3 py-8 md:pr-15 pr-1 bg-primaryBg">
                ...
                <motion.div variants={fade} initial="hidden" animate="visible" className="text-white mt-16 md:mt-0 md:col-span-1 p-4">
                    <Details />
                </motion.div>
